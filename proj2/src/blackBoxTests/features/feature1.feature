Feature: Main web page has a topic input box, collage shape input box, collage options, save to history button, and build collage button 
 
Background:
        Given that I am on the Main web page
  
Scenario: Check frontend elements
        ...
        Then there is a collage shape input box
       	...
       	Then there is a collage height option
