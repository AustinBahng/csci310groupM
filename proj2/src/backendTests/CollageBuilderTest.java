...
public class CollageBuilderTest {
	...
	public void testInvalidCalculateSufficiecy() {
		CollageBuilder cb = new CollageBuilder();
		cb.buildCollage("asdfug3i17ga9we7fg3or899asdvuga7w3o8r7giuasef", "dog", 0, 1, 1);
		boolean valid = cb.calculateSufficiecy();
		assertFalse(valid);
	}
	...
	public void testValidBuildCollage() {
		CollageBuilder cb = new CollageBuilder();
		Collage test = cb.buildCollage("dog", "dog", 0, 1, 1);
	...
	public void testInvalidBuildCollage() {
		CollageBuilder cb = new CollageBuilder();
		Collage test = cb.buildCollage("asdfuig2ior79iu73t9aosdufoogaowiurg23f3ougaef2jkasdhfiu", "dog", 0, 1, 1);
